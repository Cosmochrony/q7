...
constants $A_H$ and $A_z$, which the lemma does not evaluate.
  ...
  \subsection{The covariance rotation, and the two pairs where it matters}
    ...
    \paragraph{The rotation inside the horizontal plane, and when it is harmless.}
      ...
      lies between $10^{-16}$ and $2 \times 10^{-15}$ at nine pairs, and is resolved at two:
      $6.2 \times 10^{-3}$ at $(61,3)$ and $1.6 \times 10^{-2}$ at $(101,7)$ (at $(101,3)$ the
      near-degenerate plane is the same one, the resolved gap being the flat mode's).
      ...
      At those nine pairs the rotation of the plane is accordingly not determined by the data at
      ...
      $(q,c) = (151,5)$.
      Note that at the eight scalar-block pairs the conclusion does not depend on how the
    ...
    \paragraph{What happens at $(151,5)$.}
      ...
      the covariance plane is degenerate to within $1.5 \times 10^{-16}$.
